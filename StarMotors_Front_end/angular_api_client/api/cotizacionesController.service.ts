...
export class CotizacionesControllerService {
     ...
     */
    public findByCedulaClienteUsingGET(cedula: string, idConcesionaria: number, observe?: 'body', reportProgress?: boolean): Observable<Array<Cotizaciones>>;
    public findByCedulaClienteUsingGET(cedula: string, idConcesionaria: number, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Array<Cotizaciones>>>;
    public findByCedulaClienteUsingGET(cedula: string, idConcesionaria: number, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Array<Cotizaciones>>>;
    public findByCedulaClienteUsingGET(cedula: string, idConcesionaria: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
