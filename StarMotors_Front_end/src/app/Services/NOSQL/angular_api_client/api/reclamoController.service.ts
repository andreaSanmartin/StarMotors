...
export class ReclamoControllerService {
     ...
     * @param listaManoObra listaManoObra
     * @param listaRepuestos listaRepuestos
     * @param subTotalManoObra subTotalManoObra
     * @param subTotalRepuestos subTotalRepuestos
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public postInformeProformaReparacionUsingPOST(detalle: string, fecha: string, idEmpleadoAPIRestSQL: number, idGarantia: number, listaManoObra: string, listaRepuestos: string, subTotalManoObra: number, subTotalRepuestos: number, observe?: 'body', reportProgress?: boolean): Observable<any>;
    public postInformeProformaReparacionUsingPOST(detalle: string, fecha: string, idEmpleadoAPIRestSQL: number, idGarantia: number, listaManoObra: string, listaRepuestos: string, subTotalManoObra: number, subTotalRepuestos: number, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public postInformeProformaReparacionUsingPOST(detalle: string, fecha: string, idEmpleadoAPIRestSQL: number, idGarantia: number, listaManoObra: string, listaRepuestos: string, subTotalManoObra: number, subTotalRepuestos: number, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
    public postInformeProformaReparacionUsingPOST(detalle: string, fecha: string, idEmpleadoAPIRestSQL: number, idGarantia: number, listaManoObra: string, listaRepuestos: string, subTotalManoObra: number, subTotalRepuestos: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (detalle === null || detalle === undefined) {
            throw new Error('Required parameter detalle was null or undefined when calling postInformeProformaReparacionUsingPOST.');
        }

        if (fecha === null || fecha === undefined) {
            throw new Error('Required parameter fecha was null or undefined when calling postInformeProformaReparacionUsingPOST.');
        }

        if (idEmpleadoAPIRestSQL === null || idEmpleadoAPIRestSQL === undefined) {
            throw new Error('Required parameter idEmpleadoAPIRestSQL was null or undefined when calling postInformeProformaReparacionUsingPOST.');
        }

        if (idGarantia === null || idGarantia === undefined) {
            throw new Error('Required parameter idGarantia was null or undefined when calling postInformeProformaReparacionUsingPOST.');
        }

        if (listaManoObra === null || listaManoObra === undefined) {
            throw new Error('Required parameter listaManoObra was null or undefined when calling postInformeProformaReparacionUsingPOST.');
        }

        if (listaRepuestos === null || listaRepuestos === undefined) {
            throw new Error('Required parameter listaRepuestos was null or undefined when calling postInformeProformaReparacionUsingPOST.');
        }

        if (subTotalManoObra === null || subTotalManoObra === undefined) {
            throw new Error('Required parameter subTotalManoObra was null or undefined when calling postInformeProformaReparacionUsingPOST.');
        }

        if (subTotalRepuestos === null || subTotalRepuestos === undefined) {
            throw new Error('Required parameter subTotalRepuestos was null or undefined when calling postInformeProformaReparacionUsingPOST.');
        }
        ...
        if (listaManoObra !== undefined && listaManoObra !== null) {
            queryParameters = queryParameters.set('listaManoObra', <any>listaManoObra);
        }
        if (listaRepuestos !== undefined && listaRepuestos !== null) {
            queryParameters = queryParameters.set('listaRepuestos', <any>listaRepuestos);
        }
        ...
        return this.httpClient.request<any>('post',`${this.basePath}/reclamo/proforma/post`,
            {
                params: queryParameters,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
